...
--
-- Name: post_category; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.post_category OWNER TO "user";

--
-- Data for Name: author; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.author (id, name, created_at, updated_at) FROM stdin;
1	Dummy User	2017-05-18 13:50:19	2017-05-18 13:50:19
\.
...
COPY public.category (id, name, tag, created_at, updated_at) FROM stdin;
1	Makanan	food	2017-05-18 13:50:19	2017-05-18 13:50:19
2	Kehidupan	life	2017-05-18 13:50:19	2017-05-18 13:50:19
3	Kasih Sayang	love	2017-05-18 13:50:19	2017-05-18 13:50:19
\.
...
COPY public.post (id, title, content, author_id, updated_at, created_at) FROM stdin;
...
--
-- Data for Name: post_category; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.post_category (id, post_id, category_id) FROM stdin;
1	1	1
2	1	2
3	1	3
4	2	1
