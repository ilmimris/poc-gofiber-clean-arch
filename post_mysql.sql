CREATE DATABASE  IF NOT EXISTS `post` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `post`;
...
CREATE TABLE `post_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `composite` (`post_id`,`category_id`)
...
INSERT INTO `post_category` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3),(7,3,3),(8,4,3),(9,5,2),(11,6,1),(10,6,2);
...
INSERT INTO `author` VALUES (1,'Dummy User','2017-05-18 13:50:19','2017-05-18 13:50:19');
